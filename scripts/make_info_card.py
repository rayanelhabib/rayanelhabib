...
# ===========================================================================
HOST = "rayanelhabib"   # shown as  rayanelhabib@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "IT Developer & Student"),
    ("kv", "Edu", "Universite de Rouen Normandie"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "JavaScript, Python, Java"),
    ("kv", "Frontend", "React, HTML/CSS, Next.js"),
    ("kv", "Backend", "Node.js, Express, Discord.js"),
    ("kv", "Tools", "Git, Docker, VS Code"),
    ("kv", "Hosting", "Vercel, GitHub Pages"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "50+ public repos across web, bots & AI"),
    ("bul", "Discord bot with 10+ stars"),
    ("bul", "Competitive coding enthusiast"),
]
